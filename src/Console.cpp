...
void ConsoleClass::onInterruptPlaysheet(void (*interruptPlaysheetHandler)()) {
    this->interruptPlaysheetHandler = interruptPlaysheetHandler;
}

void ConsoleClass::onRunPlaysheet(void (*runPlaysheetHandler)()) {
...
void ConsoleClass::checkCommand() {
    ...
    switch (incomingByte) {
        case 'a':
            if (this->runPlaysheetHandler != NULL) {
                this->runPlaysheetHandler();
            }
            break;
        case 'b':
            if (this->interruptPlaysheetHandler != NULL) {
